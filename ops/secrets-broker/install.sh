...
policy.backends ||= {};
policy.backends.openbao = { ...(policy.backends.openbao || {}), type: 'openbao-kv' };
...
policy.secrets ||= {};
policy.secrets['openbao.writer'] ||= { backend: 'openbao', write: { projectName: 'openbao', capability: 'secret.write', scopes: ['secrets:3dvr-agent'], approval: { mode: 'auto' } } };
