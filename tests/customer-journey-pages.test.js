...
describe('portal customer journey pages', () => {
  it('gives the portal home a clear concrete entry path', async () => {
    ...
    assert.match(html, /<p class="hero-tagline">Start small\. Pick one next step for today\.<\/p>/);
    ...
    assert.match(html, /What feels scattered today\?/);
    ...
    assert.match(html, /href="life\/index\.html">Daily Direction<\/a>/);
    assert.match(html, /href="life\/index\.html" class="cta primary">Take one small step<\/a>/);
    ...
    assert.match(html, /One messy thought, one step/);
    ...
    assert.match(html, /activeAppLane === 'simple'/);
    assert.match(html, /setActiveAppLane\('simple'\)/);
  ...
  it('keeps the free trial page tied to the portal account journey', async () => {
    ...
    assert.match(html, /Sort one messy thought\. Pick one small next step\. No card\. No big plan\./);
    assert.match(html, /Try it now/);
    assert.match(html, /Start Daily Direction/);
    assert.match(html, /Pick one small step/);
    assert.match(html, /Send free link/);
    assert.match(html, /Email me my free link/);
    assert.match(html, /Email is optional\. You can start Daily Direction now\./);
    assert.match(html, /Sign in or create account/);
    assert.match(html, /Open billing center/);
    assert.match(html, /Open start flow/);
    assert.match(html, /href="\/life\/index\.html">Start Daily Direction<\/a>/);
  });
  ...
  it('turns the start page into a compact onboarding router with easy plan access', async () => {
    ...
    assert.match(html, /Organize your life\. Find your next step\./);
    assert.match(html, /Use builder skills to improve your life, begin a career, advance in your current work/);
    assert.match(html, /4 clear paths/);
    ...
    assert.match(html, /Four ways to begin/);
    ...
    assert.match(html, /Find direction/);
    assert.match(html, /Start Career Launch/);
    assert.match(html, /Build an Opportunity Brief/);
    assert.match(html, /Open Launch Room/);
