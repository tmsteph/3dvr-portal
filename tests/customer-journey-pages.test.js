...
describe('portal customer journey pages', () => {
  ...
  it('turns the start page into a compact onboarding router with easy plan access', async () => {
    ...
    assert.match(html, /Organize your life\. Find your next step\./);
    assert.match(html, /Free Plan: sort one messy thought, pick one small next step, and leave with one move for today\./);
    ...
    assert.match(html, /I have an idea/);
    assert.match(html, /Shape the next move/);
    assert.match(html, /I need help building/);
    ...
    assert.match(html, /I need help building/);
    assert.match(html, /Simple launch help/);
    assert.match(html, /I already pay/);
