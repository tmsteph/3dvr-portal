...
describe('portal logo branding', () => {
  it('brands the SVG app logo and boot text as 3dvr portal', async () => {
    ...
    assert.match(swirlScript, /makePortalTunnelTexture/);
    assert.match(swirlScript, /CircleGeometry\(0\.78, 96\)/);
    assert.match(swirlScript, /CylinderGeometry\(0\.46, 0\.74, 0\.3, 96, 1, true\)/);
    assert.match(swirlScript, /portalDepth/);
    ...
    assert.match(swirlScript, /createRadialGradient\(center, center, 0, center, center, radius\)/);
    assert.match(swirlScript, /createRadialGradient\(0, 0, 0, 0, 0, radius \* 0\.82\)/);
