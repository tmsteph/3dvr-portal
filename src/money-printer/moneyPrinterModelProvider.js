...
function buildInstructions() {
  return [
    ...
    'Treat operationQueue as execution memory. Avoid re-planning materially equivalent work already planned, approved, or executing. Repeat executed work only when fresh evidence or a recurring need requires it. Diagnose failed or skipped outcomes before retrying instead of blindly repeating them.',
...
export function buildStatePayload(context = {}) {
  ...
  return {
    ...
    operationQueue: state.operationQueue || context.operationQueue || { total: 0, counts: {}, recent: [] },
