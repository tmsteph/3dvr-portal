...
export function createCrmCheckHandler({ config = process.env } = {}) {
  const peer = config.THREEDVR_GUN_RELAY || 'https://gun-relay-3dvr.fly.dev/gun';

  return async function crmCheckHandler(req, res) {
