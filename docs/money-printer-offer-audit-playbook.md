# Money Printer Offer Audit Playbook
...
- Wants passive income with no buyer contact.
- Refuses outreach.
...
I am only looking for a few builders where this would create immediate clarity. If the offer audit is not useful right now, no problem. If it is, send me the messy version of what you are trying to sell and I will tell you whether I think the $300 audit is worth doing.
...
- Five outreach messages
- 7-day validation checklist
- Kill/scale decision rule

## Success Metrics

After 25 touches:

- Minimum viable signal: 3 specific replies.
- Strong signal: 1 paid audit or 2 booked calls.
- Scale signal: 2 paid audits from the same segment.
...
Scale only after a paid audit or two booked calls from the same buyer type.
